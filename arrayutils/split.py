def split(a, axis=-1, indices_or_sections=None):
    ...
    wrapper of the numpy.split function. see the definition of a, axis and indices_or _sections
    ...
    3. the default axis is -1, which means the last dimension of an array.
